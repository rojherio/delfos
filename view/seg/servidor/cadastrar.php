...
$stmt = $db->prepare("
  ...
  WHERE us.responsavel_seg_usuario_id = ? 
  ORDER BY us.eo_setor_id ASC;");
$stmt->bindValue(1, $id);
$stmt->execute();
          ...
          <form class="form" id="form_usuario" name="form_usuario" method="post" action="">
            ...
            <div class="box box-outline-primary mt-3">
              ...
              <div class="box-body">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="email_inst_u">E-mail institucional<span class="text-danger">*: </label>
                      <div class="input-group mb-3 controls">
            ...
            <div class="box box-outline-primary mt-3">
              ...
              <div class="box-body">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <label for="">Setores de responsabilidade do Usuário: </label>
                    <div class="form-group">
                      <div class="checkbox mt-20">
                        <?php
                        foreach ($rsSetores as $kSetor => $vSetor) {
                          $checked = in_array($vSetor['id'], array_column($rsUsuarioSetores, 'eo_setor_id')) ? 'checked="true"' : ''; 
                          ?>
                          <input type="checkbox" class="filled-in chk-col-success" id="setor_<?= $vSetor['id'] ;?>_u" name="setor_<?= $vSetor['id'] ;?>_u" <?= $checked ;?> value="<?= $vSetor['id'] ;?>"/>
                          <label for="setor_<?= $vSetor['id'] ;?>_u"><?= $vSetor['nome'] ;?></label> 
                          <?
                        }
                        ?>
                      </div>
